...
A resume page is good at listing what I've done. It's not very good at
explaining *how* I think about a problem, or walking through something I
learned the hard way. That's what this section is for.

## What to expect

- Short, practical write-ups — not exhaustive tutorials.
- A mix of backend engineering, AI tooling, and the occasional post-mortem.
- Some posts written first in Spanish, translated to English afterward (or
  vice versa) — so it's normal to see one language show up before the other.
