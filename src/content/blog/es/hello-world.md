...
Un CV es bueno para listar lo que he hecho. No es tan bueno para explicar
*cómo* pienso un problema, o para contar algo que aprendí a las malas. Para
eso es esta sección.

## Qué esperar

- Artículos cortos y prácticos — no tutoriales exhaustivos.
- Una mezcla de ingeniería backend, herramientas de IA, y algún que otro
  post-mortem.
- Algunos artículos escritos primero en español y traducidos al inglés
  después (o al revés) — así que es normal ver un idioma antes que el otro.

Gracias por leer — pronto habrá más.
